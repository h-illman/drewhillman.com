  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          <p className="text-foreground leading-relaxed">
            ...
            </TextLink>. That was my own tool, built independently, for tracking performance-per-watt metrics on GPU workloads with SLO-style alerting. It wasn't built for Aurovex, but it demonstrated the kind of observability and performance thinking the team was looking for.
          </p>
          <p className="text-foreground leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          <p className="text-foreground leading-relaxed">
            It was the kind of startup environment where if something was worth building, it had to be useful. There wasn't room for tooling that looked good in a demo but didn't help anyone day to day. I liked that constraint. It kept the work grounded and gave me a clear feedback loop: if the dashboard I built wasn't answering the right questions, I'd hear about it quickly, and I could fix it quickly.
          </p>
          <p className="text-foreground leading-relaxed">
            I also liked being close to the product decisions. The analytics I provided fed directly into conversations about what to build next, where performance was lagging, and what customers were using. That connection between the data work and the product direction made the role feel like it mattered beyond just the technical output.
          </p>
          <p className="text-foreground leading-relaxed">
