    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          <p className="text-foreground leading-relaxed">
            Most commercial security systems are either way too expensive and overbuilt, or cheap and single-factor. We wanted to build something in between — a system that layers "something you have" (RFID), "something you are" (fingerprint), and "something you know" (PIN) into one device, all for under $75 in parts.
          </p>
          <p className="text-foreground leading-relaxed">
            This was a team of three for our ECE 2242 design course. We took it from TinkerCAD simulation all the way to a soldered PCB mounted on a demo base with a working mechanical latch. It's a real, functioning thing — not just a breadboard prototype that works if you don't breathe on it.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          ...
          <p className="text-foreground leading-relaxed">
            We also hit an I2C address collision between the keypad expander module and the LCD — they shipped with the same default address. Fixed it by soldering a jumper on the LCD board. It's a two-minute fix once you know what's wrong, but it took a lot longer to figure out why the keypad was acting weird.
          </p>
          <p className="text-foreground leading-relaxed">
            The servo was another headache. It pulled enough current to occasionally brownout the Arduino, causing random resets mid-operation. We tried a pull-down resistor first (didn't fully fix it), and eventually just managed it in code by only powering the servo during the actual unlock window. Not elegant, but reliable.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          <p className="text-foreground leading-relaxed">
            Working with constrained hardware is a completely different kind of engineering than software. You can't just add a library or throw more RAM at the problem — you have to think about every pin, every milliamp, every byte of serial buffer. PCB design forces you to commit in a way that breadboards don't; the discipline of getting the schematic right before sending it to fab taught me a lot about being careful with design decisions.
          </p>
          <p className="text-foreground leading-relaxed">
            The biggest process lesson was that we spent way less time debugging once we started isolating subsystems individually before integrating. Testing the fingerprint sensor alone, then RFID alone, then keypad alone, then combining them — it's obvious in hindsight, but it's easy to skip when you're excited to see the whole thing work.
          </p>
          <p className="text-foreground leading-relaxed">
            If I were to do it again, I'd swap the Uno for an ESP32. You'd get Wi-Fi, a second serial port, and more pins — which would eliminate most of the hardware workarounds we had to build.
          </p>
        </div>
      </section>
    </div>
