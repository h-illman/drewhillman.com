    ...
    <div className="space-y-8">
      ...
      <div className="prose prose-lg max-w-none space-y-4">
        ...
        <p className="text-foreground leading-relaxed">
          Sunstang is Western's solar car team. We design, build, and race a fully electric solar-powered vehicle for the American Solar Challenge. The battery pack is the heart of the car's electrical system, and as lead I'm responsible for the design, integration, testing, and overall direction of the pack and everything connected to it. But the part of this role I care about most is the team itself.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          ...
          <p className="text-foreground leading-relaxed">
            A lot of my time goes into helping people. Helping newer members figure out where to start. Sitting down with someone to work through a wiring problem. Explaining how a subsystem works for the third time, because honestly, some of these systems are confusing and it takes a few passes before they click. I spend a good amount of time just being present in the shop, making sure people feel like they can ask questions without it being a big deal.
          </p>
          <p className="text-foreground leading-relaxed">
            I organize the weekly work sessions, figure out what needs to happen next, and try to keep things moving without micromanaging. Some weeks I'm deep in the technical work. Other weeks I barely touch a tool and spend the whole session bouncing between conversations, unblocking people, or helping someone debug something. Both kinds of sessions feel productive in different ways.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          <p className="text-foreground leading-relaxed">
            The thing I've come to appreciate most about this role is that being a lead is less about having all the answers and more about creating an environment where people want to show up and do good work. That sounds obvious when you say it out loud, but it's something I've had to learn through experience.
          </p>
          <p className="text-foreground leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          ...
          <p className="text-foreground leading-relaxed">
            ...
            {" "}of the battery pack to simulate temperature behavior under racing conditions. That project helped us make informed decisions about cooling and cell spacing before committing to a physical design.
          </p>
          <p className="text-foreground leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-lg max-w-none space-y-4">
          ...
          <p className="text-foreground leading-relaxed">
            The technical work mattered, and I'm proud of the projects we built. But when I think about what this role gave me, it's the human part that stands out. The trust from teammates, the friendships, the shared sense that we're all building something together that none of us could've done alone. That's the part I'll carry forward.
          </p>
        </div>
      </section>
    </div>
